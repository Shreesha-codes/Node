    ...
    <>
      ...
      <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10'>
        ...
        <div className='flex justify-between items-center mb-8'>
          ...
          <button className='bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-lg font-medium shadow-md transition-all duration-200 inline-flex items-center gap-2'>
